...
const Mainsection2 = ({ title, imgUrl }) => {
        ...
        <main className={mainstyles.main_section}>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.grid_two_section}>
                    ...
                    <div className={mainstyles.main_image} style={{paddingRight:'20%'}}>

                        <Image className={mainstyles.rightpadding } src={imgUrl} alt="Watching FakeFlix" width={500} height={500} />



                    </div>

                    <div className={mainstyles.main_content} style={{paddingLeft:'18%'}}>
